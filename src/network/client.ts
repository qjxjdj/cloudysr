...
import { Tutorial } from "../../resources/autogenerated/cs.tutorial";
...
export class Client {
    ...
    public sendPacket<T extends object>(type: MessageType<T>, message: PartialMessage<T>) {
        const name = type.typeName.split("proto.")[1] as keyof typeof PacketIds; //workaround cause im a lazy fuck 🥺
