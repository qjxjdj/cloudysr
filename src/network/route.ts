...
import { Player, PlayerManager } from "../game/players";
...
export class PacketContext<T extends object>{
    constructor(readonly request: PartialMessage<T>, readonly client: Client, readonly player?: Player){}
...
export class RouteManager{
    ...
    public handle(client: Client, packet: DataPacket){
        ...
        route.handlers.forEach(handler => {
            handler(new PacketContext(route.type.fromBinary(packet.data), client, PlayerManager.players.get(client.playerUid)));
        });
    }
}